...
base_url = "https://www.youtube.com/feed/trending" # 유튜브 인기급상승
url_music =   "?bp=4gINGgt5dG1hX2NoYXJ0cw%3D%3D"
url_game = "?bp=4gIcGhpnYW1pbmdfY29ycHVzX21vc3RfcG9wdWxhcg%3D%3D"
url_movie = "?bp=4gIKGgh0cmFpbGVycw%3D%3D"

url = base_url    # 접속하고자 하는 웹 사이트
...
print(title_hrefs[0].prettify()) # 첫 번째 항목 출력


#%%
print(title_hrefs[5].prettify())

#%%


title_hrefs[6].get('aria-label') # aria-label뽑기 : 제목,  url
title_hrefs[6].get('title')


#%%
channel_hrefs = soup.select('ytd-video-meta-block')  # 게시자(체널), 조회수, 올린시간(~전)

#%%
"""
<div id="container" class="style-scope ytd-channel-name">
  <div id="text-container" class="style-scope ytd-channel-name">
    <yt-formatted-string id="text" link-inherit-color="" title="The CHOOM (더 춤)" class="style-scope ytd-channel-name complex-string" ellipsis-truncate="" ellipsis-truncate-styling="" has-link-only_=""><a class="yt-simple-endpoint style-scope yt-formatted-string" spellcheck="false" href="/@TheChoomofficial" dir="auto">The CHOOM (더 춤)</a></yt-formatted-string>
  </div>
  <tp-yt-paper-tooltip fit-to-visible-bounds="" class="style-scope ytd-channel-name" role="tooltip" tabindex="-1" style="inset: -38px auto auto 246px;"><!--css-build:shady--><div id="tooltip" class="style-scope tp-yt-paper-tooltip hidden" style-target="tooltip">
...
# top100개 제목이랑 url 뺴오기
for title_href in title_hrefs[0:100]:
    title = title_href['title']        
    url = "https://www.youtube.com/" + title_href['href'] 
    titles.append(title)
    urls.append(url)
...
<ytd-badge-supported-renderer class="style-scope ytd-channel-name" system-icons="" disable-upgrade="" hidden=""><!--css-build:shady--><!--css-build:shady--><dom-repeat id="repeat" as="badge" class="style-scope ytd-badge-supported-renderer"><template is="dom-repeat"></template></dom-repeat></ytd-badge-supported-renderer>
  ...
  <div id="metadata-line" class="style-scope ytd-video-meta-block">
    ...
    <div id="separator" class="style-scope ytd-video-meta-block" hidden="">•</div>
      ...
      <span class="inline-metadata-item style-scope ytd-video-meta-block">조회수 376만회</span>
    
      <span class="inline-metadata-item style-scope ytd-video-meta-block">1일 전</span>
